/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+c+csharp+cpp+diff+docker+git+json+json5+markdown+python+jsx+tsx+toml+typescript&plugins=line-numbers+diff-highlight */
var _self =
