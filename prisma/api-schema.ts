            ...
            "application/json":
              ...
              | {
                  certSlug:
                    ...
                    | "quality-assurance-v7"
                    | "scientific-computing-with-python-v7"
                    | "data-analysis-with-python-v7"
                    | "information-security-v7"
                    | "machine-learning-with-python-v7"
                    | "college-algebra-with-python-v8"
                    | "foundational-c-sharp-with-microsoft"
                    | "full-stack-developer-v9"
                    | "a2-english-for-developers-v8"
                    | "b1-english-for-developers-v8"
                    | "a2-professional-spanish-v8"
                    | "a2-professional-chinese-v8"
                    | "a1-professional-chinese-v8"
                    | "legacy-front-end"
