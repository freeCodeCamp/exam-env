...
async function main() {
  ...
  jsonSchema.definitions.EnvMultipleChoiceQuestion.required.push("audio", "answers");
  jsonSchema.definitions.EnvAudio.required.push("captions","startTimeInMS","endTimeInMS");
  ...
  jsonSchema.definitions.EnvMultipleChoiceQuestionAttempt.required.splice(jsonSchema.definitions.EnvMultipleChoiceQuestionAttempt.required.indexOf("submissionTimeInMS"),1)
